...
public class EnsembleModel
{
    ...
    public Domain.Entities.ML.Ensemble.EnsemblePrediction Predict(ModelInput input)
    {
        ...
        // Örneğin; ağırlıklı ortalama ile birleştirme: %70 LightGBM, %30 PCA
        float ensembleProbability = 0.7f * lightGbmPrediction.Probability + 0.3f * pcaPrediction.Probability;
        bool ensembleLabel = ensembleProbability >= 0.5f;
